...
| GPS·핀 thumb = **로컬만** (`shouldDownloadFromNetwork: false`). iCloud 원본 다운로드 안 함. 배치 32·yield 40 | 월 로드 networkFallback / thumb iCloud warm | 첫 인덱싱 속도·발열. 클라우드 전용 사진은 GPS 없을 수 있음 | 2026-08-10 |
