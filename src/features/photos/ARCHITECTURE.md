...
| `placeJourney.ts`(535줄) → **adminNames/placeLabels/placeJourney 3분할** | 단일 파일 유지 | 300줄 규칙. 이름정규화·라벨조합·지오코딩 오케스트레이션 관심사 분리. `labelsForVisitLevel`는 placeJourney에서 재export해 외부 import 무변경 | 2026-07-22 |
