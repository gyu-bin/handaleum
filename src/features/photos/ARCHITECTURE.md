...
| 결정 | 대안 | 선택 이유 | 날짜 |
|---|---|---|---|
| **UI=journal** (크림·terracotta·serif 크롬) / **Map=dawn-blue** (land/water/accent·핀·Naver 스타일 유지). `theme.colors.terracotta`는 UI만, 맵 팔레트는 교체 금지 | 전면 저널 맵 리틴트 / UI도 dawn 유지 | 사용자 1-B. 맵 정체성 보존 + 리스트·내비만 시안 맞춤 | 2026-08-02 |
