...
| 방문 마커: **종이 프레임 + 꼬리 핀** (대표 썸네일). 커스텀 뷰 스냅샷, Image onLoad 후 remount. 장수 캡션 없음 | 사각 httpUri만 / 숫자 배지 | 핀 느낌 | 2026-07-27 |
...
- 이 feature가 의존하는 것: expo-media-library, expo-location, @mj-studio/react-native-naver-map, react-native-svg (카드/스플래시), react-native-gesture-handler, react-native-reanimated, assets/geo/*, lib/storage, shared/constants
