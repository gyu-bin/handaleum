...
| 홈 내비게이션: **하단 네비 바**(월/몰아보기/회고, 엄지 영역) + 설정은 헤더 우상단 조용한 링크. Stack 구조 유지 | 상단 칩 4개 유지 / 풀 탭바 | UX 진단(Quick Access·Clear Priority). 월선택·몰아보기는 지도 맥락의 액션이라 탭보다 하단 바가 적합 | 2026-07-21 |
| 몰아보기 **자동 재생** 추가 (재생/멈춤 토글, 2.8s 간격, 드래그 시 멈춤, 끝에서 정지) | 수동 스와이프만 | UX 진단. "몰아보기"란 이름의 기대 충족. spec 1차 제외를 사용자 결정으로 되살림 | 2026-07-21 |
