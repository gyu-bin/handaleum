...
| 방문 마커: **종이 프레임 + 꼬리 핀**. 앨범 썸네일은 `expo-image-manipulator`로 앱 캐시 `file://` JPEG export 후 RN Image + Naver overlay remount. `ph://`/DCIM 직접 로드 불가 | ph:// 직접 / expo-image 스냅샷 | 실기기 빈 핀 수정 | 2026-07-28 |
