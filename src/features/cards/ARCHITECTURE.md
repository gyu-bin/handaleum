...
| 카드 **제목·코멘트 편집** 지원 (`updateCard` + 미리보기 인라인 편집, 편집 중 실시간 반영) | 삭제 후 재생성 유지 | UX 진단(User Control). 사진·지도·템플릿은 고정, 텍스트만. 스키마 변경 없음 | 2026-07-21 |
...
- 카드 편집: **제목·코멘트만** 수정 가능 (2026-07-21). 사진·지도·템플릿 변경은 여전히 삭제 후 재생성
